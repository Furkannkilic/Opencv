...
cap = cv2.VideoCapture(0) # VideoCapture, videoyu webcamden mi yoksa dosyadan mı okuyacağımızı belirtmek için kullanılır. 0, burada webcamden okuyacağımızı gösterir.
...
while True:  # Sonsuz döngü
    ...
    cv2.imshow("WEBCAM",frame)  # Okuduğumuz frameleri tek tek göreceğiz.
